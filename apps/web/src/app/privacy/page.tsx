    ...
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-4 py-12">
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>
            A random session ID, interaction events, and derived scores live on the API (memory, local files, or
            Upstash / Vercel KV). Optional notes are classified for keywords, then dropped — Fit does not keep the raw
            text.
          </p>
          <p>Share links store a score snapshot and canned evidence labels, not your typed notes.</p>
